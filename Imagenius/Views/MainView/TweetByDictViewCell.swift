...
class TweetByDictViewCell: SWTableViewCell {
    ...
    // 要素の設定-----------------------------------------------------------------
    func setOutlet(tweet: Dictionary<String, JSONValue>, tweetHeight: CGFloat) {
        ...
        let imageCount = tweetMedia["media"].array!.count

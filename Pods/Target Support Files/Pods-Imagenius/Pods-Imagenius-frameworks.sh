...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "Pods-Imagenius/Alamofire.framework"
  ...
  install_framework "Pods-Imagenius/RxBlocking.framework"
  install_framework "Pods-Imagenius/RxCocoa.framework"
  install_framework "Pods-Imagenius/RxSwift.framework"
  install_framework "Pods-Imagenius/SDWebImage.framework"
  install_framework "Pods-Imagenius/SWTableViewCell.framework"
  install_framework "Pods-Imagenius/SwiftyJSON.framework"
